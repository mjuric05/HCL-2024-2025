...
export default function SignInAndLogInPage() {
    ...
    return (
        <main className="flex min-h-screen flex-col items-center p-4 pt-24 md:p-10 md:pt-28">
            <div className="flex flex-col md:flex-row justify-center w-full md:w-3/4 mt-8 space-y-8 md:space-y-0 md:space-x-8 mx-auto">
                {displayLogin ? (
                    // Log In
            ...
            <div className={`w-full md:w-3/4 mt-8 ${frameClassName}`}>
                ...
                <ul className="list-disc list-inside text-black dark:text-white">
                    <li>Email has to be in a valid format: name@domain.com</li>
                    <li>
